    ...
    <div className="space-y-6">
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-2">
          <label className="font-label-md text-xs font-semibold text-on-surface-variant block ml-1" htmlFor="name">
            Full name
          </label>
        ...
        {/* Password */}
        <div className="space-y-2">
          <label className="font-label-md text-xs font-semibold text-on-surface-variant block ml-1" htmlFor="password">
            Password
          </label>
          <div className="relative group">
            <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-outline group-focus-within:text-primary transition-colors">
      ...
      <div className="mt-8 text-center">
        <p className="font-body-md text-sm text-on-surface-variant">
          ...
          <Link className="text-primary font-bold hover:underline transition-all" href="/signin">
            Sign In
          </Link>
        </p>
      </div>
